      ...
      return this.each(
        function()
        {
          ...
          if (settings.window.expandable)
            $($this).after('<span class="jPicker color-swatch"><span class="Icon"><span class="Color">&nbsp;</span><span class="Alpha">&nbsp;</span><span class="Image" title="Click To Open Color Picker">&nbsp;</span><span class="Container">&nbsp;</span></span></span>');
              ...
              function()
              {
                ...
                switch (settings.window.effects.type)
                {
                  case 'fade':
                    ...
                    break;
                  case 'slide':
                  	container.fadeIn(100, attachIFrame);
              ...
              function()
              {
                ...
                switch (settings.window.effects.type)
                {
                  case 'fade':
                    ...
                    break;
                  case 'slide':
                  	container.fadeOut(100, removeIFrame);
      ...
      images:
        {
          ...
          picker:
          {
            file: 'color-arrow.png', /* Color Picker icon */
            width: 25,
            height: 24
          }
        },
