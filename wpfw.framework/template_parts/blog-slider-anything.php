<div id="BlogSliderContainer" class="WebsiteWidth">
	<ul id="BlogSlider" class="AS arrows buttons">
	<?php					
  	$slides= wp_count_posts('homeslider');
  	$total = $slides->publish;
		$the_query2 = new WP_Query("post_type=blogslider&orderby=menu_order&order=ASC&posts_per_page=-1");
		$nr = 1;
