<div class="cshares">
	<span>Share</span>
	<a onclick="return !window.open(this.href, 'Pinterest', 'width=640,height=300')" 
		href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&amp;media=<?php 
		echo get_thumbnail_src(get_the_post_thumbnail(get_the_ID(),'blog_footer')); ?>&amp;description=<?php 
		echo rawurlencode(get_the_title()); ?>" 
		class="cshare zocial pinterest" 
		title="Post on Pinterest"></a>
	
	<a onclick="return !window.open(this.href, 'Twitter', 'width=640,height=300')" 
		href="http://twitter.com/share?url=<?php 
			the_permalink(); ?>&amp;text=<?php 
			echo urlencode(get_the_title()); ?>" 
		class="cshare zocial twitter" 
		title="Post on Twitter"></a>
	...
	<a onclick="return !window.open(this.href, 'Facebook', 'width=640,height=300')" 
		href="http://www.facebook.com/sharer.php?s=100&amp;<?php 
			...
			echo urlencode('p[summary]'.get_excr(150)); ?>&amp;<?php 
